...
abstract class Backup
{
    ...
    private array $skipTables = [
        ...
        'in.c-from_L0_Sourcing_MTV.MTV_PLATFORM',
        ...
        'in.c-from_L0_Sourcing.NETMONITOR_WEEK',
        'in.c-from_L0_Sourcing_MTV.MTV_MARKETING-VIEWS',
        'in.c-from_L0_Sourcing_MTV.MTV_PLATFORM-CATALOG',
        ...
        'in.c-from_L0_Sourcing_MTV.MTV_ADVERTISER-DATA',
        'out.c-TO_L3_Publicis.VOLNY_PRODEJ_PNS',
        'in.c-from_L0_Sourcing.BIGQUERY_CONTENT_PREMIUM',
        'in.c-from_L0_Sourcing.ARES_FIRMY',
        'in.c-from_L0_Sourcing.rates-eur',
        ...
        'in.c-from_L0_Sourcing_MTV.MTV_SALES_REVE_BUDGET_PIVOTTED',
        'in.c-from_L0_sourcing.PRINT_TITLE_IMAGE_URL',
        'in.c-from_L0_Sourcing_MTV.MTV_FB_OLYMPICS_INSIGHTS',
        'in.c-from_L0_Sourcing_Inzerce.caroda_instream',
        'in.c-from_L0_Sourcing.PREMIUM_BUDGET_DATA',
        'in.c-from_L0_Sourcing.BIGQUERY_ARTICLES',
        ...
        'in.c-from_L0_Sourcing.PREMIUM_CMS_DATA',
        ...
        'in.c-from_L0_Sourcing.NATIVE_PR_ARTICLES_WOMEN_GROUP_2022',
        'in.c-from_L0_Sourcing_SEO.ciselnik-ga-ciselnik',
        'in.c-from_L0_Sourcing.GA_BIGQUERY_BASIC_METRICS_DAY',
        ...
        'in.c-from_L0_Sourcing_MTV.MTV_BOARD-REPORT',
        'in.c-test_premium.PREMIUM_KONVERZE',
        'in.c-from_L0_sourcing.PRINT_SOLAR_BUDGET',
        'in.c-from_L0_Sourcing.GA_BASIC_METRICS_DAY',
        'in.c-from_L0_Sourcing.BIGQUERY_APP_KVIZUJ_STORE',
        'in.c-from_L0_Sourcing_Inzerce.AD_RLS_CLIENTS_AGENCY',
        'in.c-from_L0_Confidential.SOLAR_SUBS_MARKETING_DATA',
        'in.c-from_L0_Sourcing_MTV.MTV_PERFORMANCE-DATA',
        ...
        'in.c-from_L0_Sourcing.BIGQUERY_CONTENT_ARTICLE_VIDEO',
        'in.c-from_L0_Sourcing_MTV.MTV_GA-CTTV-VIEWS',
        'in.c-from_L3_INZERCE.04_master_cpex_alias',
        'in.c-from_L0_Sourcing.zone-line-items',
        'in.c-from_L0_Sourcing_MTV.MTV_CTTV-INCOMAKER',
        'in.c-from_L0_Sourcing.MP_UNION_BLESK_VS_KONKURENCE',
        'in.c-from_L0_Sourcing.PLANS_MONTH',
        'in.c-from_L0_Sourcing_MTV.MTV_ZDROJE-A-EMBEDY',
        ...
        'in.c-from_L0_Sourcing.BIGQUERY_CONTENT_LOYALS_MONTH',
        'in.c-from_L0_Sourcing.BIGQUERY_ARTICLES_2021',
        'in.c-from_L0_Sourcing.UNIFIED_SUBSCRIBERS',
        'in.c-from_L0_Source_Advertisement_data.PRINT_AD_DOHADY_TRANSFER',
        'in.c-from_L0_SOURCING_CISELNIKY.CISELNIK_TITLE_MAPPING',
        ...
        'in.c-from_L0_Sourcing_SEO.GSC_SEARCH_KEYWORDS',
        'in.c-from_L0_Sourcing.VP-ANALYTICS',
        'in.c-from_L0_Sourcing.seznam-klientu-adintel-inzerce-cnc',
        'in.c-from_L0_Sourcing_MTV.MTV_CTTV-EMBEDS',
        'in.c-from_L0_Source_Advertisement_data.PRINT_AD_FIX_PROVISION',
        'in.c-From_L1_Sales.PNL_PRINT_POC',
        'in.c-from_CVC_Confidential.MTV_CATALOG',
        'in.c-from_L0_Sourcing.BT_TITLES_DETAIL',
        'in.c-from_L0_Sourcing_Inzerce.OMS_ORDER_LI',
        'in.c-from_L0_Sourcing_SEO.organic-search-key-word',
        ...
        'in.c-from_L0_Sourcing_SEO.organic-search-pages-title',
        'in.c-from_CVC_Confidential.MTV_USERS',
        ...
        'in.c-from_L0_SOURCING_CISELNIKY.CISELNIK_TITLE_GROUP',
        'in.c-from_L1_Content.PLAN_MONTH',
        'in.c-from_CVC_Confidential.MTV_SUBSCRIBERS',
        ...
        'in.c-to_L1_Content.ONLINE_INZERCE_REVENUES_D2_D1',
        'in.c-from_L0_Sourcing.CISELNIK_TITLE_GROUPS',
        'in.c-from_L0_Sourcing_MTV.MTV_ZDROJE-DLE-UTM',
        'in.c-from_L0_Sourcing.PREMIUM_KONVERZE',
        'in.c-from_L0_Sourcing.BT_SOCDEM_DETAIL',
        'in.c-From_L1_Finance.ABC_CR',
        'in.c-from_L0_Sourcing_MTV.MTV_FB-PAGE-INSIGHTS',
        'in.c-from_L0_Sourcing.BIGQUERY_ECOMMERCE_CLICK',
        'in.c-from_L0_Sourcing_Inzerce.CISELNIK_WEB_MAPPING_CLEANED',
        'in.c-from_L0_sourcing.PRINT_SOLAR_CALENDAR',
        'in.c-from_L0_Sourcing_MTV.MTV_COMPARISON-2022',
        'in.c-from_L0_Sourcing_MTV.MTV_GOOGLEADS-CAMPAIGN-DATA-SK',
        ...
        'in.c-from_L0_Sourcing_MTV.MTV_CHANNEL-AGG',
        'in.c-from_L0_Sourcing.GA_WEB_PERFORMANCE',
        'in.c-from_L0_Sourcing_marketing.MEDIA_CONTRACTS',
        'in.c-from_L0_Sourcing_MTV.MTV_GA-VIEWS',
        'out.c-To_L3_Chytra_distribuce.ABC_CR_DATA',
        'in.c-from_L0_Sourcing_Inzerce.TRIPLELIFT_CPEX',
        'in.c-from_L0_Sourcing_MTV.MTV_GOOGLEADS-CAMPAIGN-DATA-CZ',
        'in.c-from_L0_Source_Advertisement_data.ADINTEL_TO_INSIDER_SUBJECT_MAPPING',
        'in.c-from_L0_Sourcing_MTV.MTV_SKLIK-CAMPAIGN-DATA',
        ...
        'in.c-from_L0_Sourcing.PLANS_DAY_CORE',
        ...
        'in.c-from_L0_Sourcing.BIGQUERY_ARTICLES_AGGREGATED',
        'in.c-from_L3_INZERCE.05_master_adform_alias',
        'in.c-from_L0_Sourcing_Inzerce.DT_IMPRESSIONS',
        'in.c-from_L0_Sourcing_MTV.MTV_PERFORMANCE-DATA_CTTV',
        'in.c-from_L0_Sourcing_Inzerce.day_netmonitor',
        'in.c-from_L0_Sourcing_marketing.MARKETING_FORECAST',
        'in.c-from_L0_Sourcing.NETMONITOR_MONTH',
        'in.c-from_L0_Sourcing.BIGQUERY_CONTENT_OVERVIEW',
        'in.c-from_L0_Sourcing_marketing.MEDIA_BRAND_NEW',
        'in.c-from_L0_Sourcing.BIGQUERY_CONTENT_VIDEO',
        ...
        'in.c-from_L0_Sourcing_MTV.MTV_FB-MARKETING-DATA',
        'in.c-from_L0_Sourcing_MTV.MTV_CTTV-TOTAL',
        ...
        'in.c-from_L0_Sourcing.BIGQUERY_PRISM_VIDEO',
        ...
        'in.c-from_L0_Sourcing_MTV.MTV_SEZNAM-STREAM-DATA',
        'in.c-from_L3_INZERCE.ONLINE_INZERCE_REVENUES',
        'in.c-from_L0_Sourcing_SEO.organic-search-source',
        'in.c-from_L1_Content.CONTENT_OVERVIEW',
        'in.c-from_L3_INZERCE.index_report',
        'in.c-from_L0_Sourcing.ADVERTISEMENT_SALES_BUDGET',
        'in.c-from_L0_Sourcing.PLANS_DAY',
        'in.c-from_L0_Sourcing_SEO.organic-search-medium',
        'in.c-from_L3_INZERCE.triplelift_alias',
        'in.c-to_L1_Content.ONLINE_INZERCE_REVENUES_D3_OLDER',
        'in.c-from_L0_Sourcing.TWITCH_ELEAGUECZ',
        'in.c-from_L0_Sourcing_marketing.GEKO',
        'in.c-from_L0_Confidential.SOLAR_SUBS_COMPLAINTS',
        'in.c-from_CVC_Confidential.MTV_QUIZZES',
        'in.c-from_L0_Sourcing.CMS_DATA',
        'in.c-from_L3_INZERCE.GALERIE_NEGALERIE',
        'in.c-From_L1_Sales.SOLAR_CALENDAR',
        'in.c-from_L0_Sourcing.BIGQURY_APP_KVIZUJ_EVENT',
        'in.c-from_L0_Sourcing.BIGQUERY_ARTICLES_AUTHORS',
        ...
        'in.c-from_L0_Sourcing_MTV.MTV_GA-USERS',
        'in.c-from_L0_Sourcing.PERFORMAX',
        'in.c-from_L0_Sourcing.ADMONITOR_MAPPING_SEGMENTACE',
        'in.c-from_L0_Sourcing_MTV.MTV_SOURCE-MEDIUM-CTTV',
        'in.c-from_L0_Sourcing.NETMONITOR_DATA',
        'in.c-from_L0_Sourcing.PRISM_VIDEO_DAY',
        ...
        'in.c-from_L0_Sourcing.BIGQUERY_ECOMMERCE_OVERVIEW',
        'in.c-from_L0_sourcing.PRINT_MONITORING_PNS',
        'out.c-to_L2_DATAMARTS.print_solar_budget_alias',
        'in.c-from_L0_Sourcing.BIGQUERY_APP_OVERVIEW',
        'in.c-from_L0_Sourcing_Inzerce.rtb-od-jonase-sas-zdroj-budget-do-tbl',
        'in.c-from_L0_Sourcing.NATIVE_PR_ARTICLES_WOMEN_GROUP',
        'out.c-to_L2_DATAMART.MTV_PLATFORM',
        'in.c-from_L0_Sourcing.INSIDER_SUBJECT',
        'in.c-from_L0_Sourcing.BIGQUERY_IKIOSEK_OVERVIEW',
